function result() {
  ...
  var yes_counter = 0;
  // 페이지에서 radio-label과 yes-button 클래스를 동시에 가진 콤포넌트들을 다 참아서 elements에 저장
  var elements = document.getElementsByClassName("radio-label yes-button");
  ...
  else if (yes_counter == 4) location.href = "result_4.html";
  else if (yes_counter >= 2) location.href = "result_3.html";
  else if (yes_counter == 1) location.href = "result_2.html";
